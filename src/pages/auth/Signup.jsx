...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Redirect to doctor dashboard (all new signups get DOCTOR + ADMIN roles)
      navigate('/doctor')
    } catch (error) {
  ...
  const handleGoogleSuccess = async (credentialResponse) => {
    ...
    try {
      ...
      // Redirect to doctor dashboard (Google users automatically get DOCTOR + ADMIN roles)
      navigate('/doctor')
    } catch (error) {
  ...
  const handleGoogleError = () => {
    setErrors(prev => ({ ...prev, general: 'Google sign in was unsuccessful. Please try again.' }))
  }
          ...
          <div className="w-full max-w-md">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-slate-300 leading-relaxed">
                Create your account and set up your clinic
              </p>
              <p className="text-sm text-slate-400 mt-2">
                You'll be set up as the admin of your new clinic
              </p>
            </div>
